...
def main():
    ...
    "на достоверность. Работай только с утверждениями, содержащими факты или значимые события, которые можно проверить. Не нужно учитывать выражение эмоций, эмодзи и прочий безсмысленный текст. "
