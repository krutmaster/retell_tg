...
def main():
    ...
    "на достоверность по сравнению со сведениями из базы данных, логики и информации в интернете (проверяй через поиск факты). "
    "Работай только с утверждениями, содержащими факты или значимые события, которые можно проверить. Не нужно учитывать выражение эмоций, эмодзи и прочий безсмысленный текст. "
